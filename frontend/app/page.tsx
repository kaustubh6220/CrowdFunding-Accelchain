        ...
        <div className='w-full shadow-md shadow-slate-700 bg-slate-700 rounded-md flex justify-between items-center mt-4'>
          <div className="text-left w-8/12 flex flex-col ml-4 p-2">
            ...
            <div className='flex flex-row gap-4 mt-8'>
              <Button asChild className='bg-green-500 hover:bg-green-600 rounded-md'>
                <Link href='#campagin'>
                  Donate
                </Link>
              </Button>
              <Button onClick={(e)=> router.push('/createCampagin')} className='bg-green-500 hover:bg-green-600 rounded-md'>Create Campaign</Button>
            </div>
          </div>
