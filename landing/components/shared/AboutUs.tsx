...
const AboutUs = () => {
  return (
    <div className='w-full flex justify-between gap-2 p-2 text-center '>
        <Card className=' bg-transparent border-emerald-500 border-2 w-1/3 mr-10'>
        ...
        <Card className=' bg-transparent border-emerald-500 w-1/3 mr-5 ml-5'>
        ...
        <Card className=' bg-transparent border-emerald-500 w-1/3 ml-10'>
